            ...
            <div className="container">
                <div className="flex flex-wrap">
                    <div className="mb-12 w-full px-4 font-medium text-slate-300 md:w-1/3">
                        <h2 className="text-bold mb-5 text-4xl text-white">SAS</h2>
                        <h3 className="mb-2 text-2xl font-bold">Hubungi Kami</h3>
                        <p className="text-sm">syahridhosyahputra@gmail.com</p>
                        <p className="text-sm">Jl.Sri palas Gg.Sri Amal 2</p>
                        <p className="text-sm">Pekanbaru</p>
                        </div>
                    <div className="mb-12 w-full px-4 md:w-1/3">
                        ...
                        <ul className="text-slate-300">
                            <li>
                            <a href={"#about"} className="mb-3 inline-block text-base hover:text-primary">Strategi</a>
                            </li>
                            <li>
                            <a href={"#portfolio"} className="mb-3 inline-block text-base hover:text-primary">Senjata</a>
                            </li>
                            <li>
                            <a href={"#clients"} className="mb-3 inline-block text-base hover:text-primary">Aliansi</a>
                            </li>
                        </ul>
                    </div>
                    <div className="mb-12 w-full px-4 md:w-1/3">
                        ...
                        <ul className="text-slate-300">
                            ...
                            <li>
                            <a href={"contact"} className="mb-3 inline-block text-base hover:text-primary">Contant</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div className="w-full border-t border-slate-700 pt-10">
                    ...
                    <a href={url} target="_blank" rel="noopener noreferrer" className="text-primary">Syahridho Arjuna
                        Syahputra</a>
                    , Menggunakan
                    <a href={url} target="_blank" rel="noopener noreferrer" className="text-bold text-sky-500">Tailwind CSS</a>
                    </p>
                </div>
            </div>
        </footer>
