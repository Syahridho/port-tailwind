        ...
        <section id="about" className="pt-36 pb-32 dark:bg-dark">
            <div className="container xl:px-10">
                <div className="flex flex-wrap">
                    ...
                    <h4 className="uppecase mb-3 text-lg font-bold text-primary">
                        Tentang Saya
                    </h4>
                    <h2 className="mb-4 text-3xl font-bold text-dark dark:text-white lg:text-3xl">
                        Yuk belajar strategi di sini!
                    </h2>
                    <p className="max-w-xl text-base font-medium text-secondary lg:text-lg">
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                        Veritatis obcaecati optio pariatur! Laborum tempore alias
                        laboriosam!
                    </p>
                    </div>
                    ...
                    <p className="mb-6 text-base font-medium text-secondary lg:text-lg">
                        ...
                        tempora distinctio eius dolorum cum omnis cupiditate neque?
                        Quibusdam.
                    </p>
